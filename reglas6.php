...
<ul>
    ...
    <div class="recuadros-reglas">
      ...
      <div class="columna">
          <p>
            <h1 >Juego:</h1>
Para entrar al casillero final (la meta), necesitas el número exacto en el dado. Por ejemplo: si te faltan 5 casilleros y sacas un 5, entras al casillero. Si sacas un 6, avanzás hasta la meta y retrocedés 1 casilleros. Así sucesivamente.
</p>
        </div>
        <div class="columna">
          <div class="img">
          <p>
            <img src="imagenes/reglasganar.png" alt="" width="450" height="450" >
          </p>
        </div> 
