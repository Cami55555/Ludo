...
.azul { background: #0066ff; border-radius: 50%; }
.verde { background: #00cc00; border-radius: 0%; }
.amarillo { background: #ffff33; clip-path: polygon(50% 0%, 0% 100%, 100% 100%); }
...
.dado-container img {
  width: 100%;      /* relativo al tablero */
  max-width: 80px; /* tamaño máximo */
  aspect-ratio: 1;
  object-fit: cover;
  cursor: pointer;
  transition: 0.2s;
...
#turno {
  position: absolute;      /* lo posicionamos sobre el tablero */
  top: 13vh;               /* un poco debajo del menú (ajusta según tu menú) */
  left: 50%;               /* centrado horizontal */
  transform: translateX(-50%); /* realmente lo centra */
  ...
  max-width: 80vw; /* opcional, para que no sea demasiado ancho */
  color: #fff;
}
...
<body>
  ...
  { x: 0.2218, y: 0.564 }, // primera casilla segura (casilla 8)
  { x: 0.4545, y: 0.235 }, // segunda casilla segura (casilla 21)
  { x: 0.808, y: 0.452 },  // tercera casilla segura (casilla 34)
  { x: 0.575, y: 0.78 }    // cuarta casilla segura (casilla 47)
];
